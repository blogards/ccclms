<?php
    ...
    $sql = "SELECT `library-resources`.`id`, title, `library-resources`.`barcode`, author, `year` FROM `library-resources`, `thesis` WHERE `library-resources`.`barcode` = `thesis`.`barcode` order by 1";
